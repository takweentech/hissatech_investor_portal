...
import { InvestorSignIn, InvestorSignUp } from '../models/investor.model';
...
export class AuthService {
  ...
  signupInvestor(investor: InvestorSignUp): Observable<CustomHttpResponse<Token>> {
    return this.http.post<CustomHttpResponse<Token>>(environment.apiUrl + `/Accounts/SignUpInvestor`, investor)
  }
}
