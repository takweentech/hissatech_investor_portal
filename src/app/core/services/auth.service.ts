...
export class AuthService {
  ...
  signIn(investor: InvestorSignIn): Observable<CustomHttpResponse> {
    return this.http.post<CustomHttpResponse>(environment.apiUrl + '/Accounts/ValidateLogin', investor)
  }
